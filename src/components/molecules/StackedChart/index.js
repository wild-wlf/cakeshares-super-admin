...
function StackCharts({ userGraphData, investmentGraphData, tooltipBg, title, amount, sm, graphLineColor, timeFrame }) {
  const dropdown = [
  ...
  const yearlyCategories = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
  ...
  const options = {
    ...
    xAxis: {
      categories:
        selected === 'monthly' ? monthlyCategories : selected === 'yearly' ? yearlyCategories : weeklyCategories,
    },
    yAxis: {
      visible: false,
    },
    ...
    series: selected === 'monthly' ? monthly : selected === 'yearly' ? yearly : weekly,
  ...
  return (
    <StyledGraph sm={sm}>
      <GraphHeader bg={tooltipBg} sm={sm}>
        <div className="head">
          ...
          <div className="dropdown">
            <Dropdown option={dropdown} title="Monthly" onChange={handleOnChange}>
              Monthly
      ...
      {userGraphData && investmentGraphData ? (
